...
const ITEMS = [
  ...
  },
  {
    ...
    levels: "Velocidade · Força · Flexibilidade · Mobilidade · Resistência",
    tags: ["Plano personalizado"],
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {ITEMS.map((it, idx) => (
            <motion.article
              key={it.title}
              data-testid={`modalidade-card-${it.title.toLowerCase().replace(/\s+/g, "-")}`}
            ...
            >
              <div className="flex items-start justify-between mb-6 gap-3">
                ...
                <div className="flex flex-col items-end gap-1.5 text-right">
                  ...
                  {it.badge && (
                    <span className="inline-flex items-center gap-1 text-[9px] font-semibold tracking-[0.12em] uppercase px-2 py-0.5 rounded-full bg-neutral-900 text-white">
              ...
              <button
                ...
                data-testid={`modalidade-cta-${it.title.toLowerCase().replace(/\s+/g, "-")}`}
